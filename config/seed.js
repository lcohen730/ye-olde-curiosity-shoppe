...
(async function() {
  ...
  const user = await User.findOne({ email: 'cthulu@lovecraft.com' });
  ...
  const comments = await Comment.create([
    { user: user,
      ...
      date: '10/31/2022 23:45' },
    { user: user,
      rating: 3, 
      content: 'Not spooky enough',
      date: '10/31/2022 23:45' },
  ]);
  ...
  const items = await Item.create([
    ...
    {name: 'Monkey\'s Paw',
      ...
      comments: [ comments[0]._id, comments[1]._id ]},
    {name: 'Zephaniah\'s Enigma',
      image: 'https://ae01.alicdn.com/kf/S39bf0809d75d4acb8bac725b729b1628v/1-1-Hellraiser-Puzzle-Box-Moveable-Lament-Horror-Terror-Figures-Film-Hellraiser-Cube-Fully-Pinhead-Prop.jpg', 
      category: categories[0], 
      price: 249.99,
      rating: 4,
      info: 'An unsolved puzzle box from the early 19th century. No human has ever known what resides within. The final owner died under mysterious circumstances.', 
      comments: [ comments[0]._id, comments[1]._id ]},
    {name: 'Ancient Map', 
      ...
      price: 114.99,
      rating: 4,
      info: 'This map was stolen from a pirate on the Black Sea. Legend says his ghost still haunts the waters.', 
      comments: [ comments[0]._id, comments[1]._id ]},
    ...
    {name: 'Black Tuks', 
      ...
      comments: [ comments[0]._id, comments[1]._id ]},
    {name: 'Long Black Gothic Cloak', 
      image: 'https://www.thedarkstore.com/24647-large_default/black-long-victorian-gothic-illuminati-cloak-coat.jpg', 
      category: categories[2], 
      price: 175.99,
      rating: 4,
      info: 'When living in the light is too much to bear, cloak yourself in darkness with this fabric of concealment.', 
      comments: [ comments[0]._id, comments[1]._id ]},
    ...
    {name: 'Necronomicon', 
      ...
      comments: [ comments[0]._id, comments[1]._id ]},
    {name: 'Edgar Allan Poe Complete Tales and Poems', 
      image: 'https://images.pangobooks.com/images/6b37a0d8-c34c-41b6-ba10-8fb5432f89ea?quality=85&width=1200&crop=1%3A1', 
      category: categories[4], 
      price: 39.99,
      rating: 4,
      info: 'In Edgar Allan Poe: Complete Tales and Poems, readers may indulge in all of Poe\'s most imaginative short-stories, including The Fall of the House of Usher, The Murders in Rue Morgue, The Tell-Tale Heart, Ligeia, and Ms. In a Bottle. His complete early and miscellaneous poetic masterpieces are here also, including The Raven, Ulalume, Annabel Lee, and Tamerlane, as well as select reviews and narratives.', 
      comments: [ comments[0]._id, comments[1]._id ]},
  ]);
